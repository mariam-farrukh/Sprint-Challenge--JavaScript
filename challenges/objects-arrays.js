...
graduates.forEach(function(currentValue){  
  ...
  {
 uni.push(currentValue.university);}
})
...
zooAnimals.forEach(function(currentValue) {
  animalNames.push(`Scientific name: ${currentValue.scientific_name}, Animal name: ${currentValue.animal_name}`);
  });
...
*/
const populationTotal = zooAnimals.reduce(function(addedTotal, currentValue){
  return addedTotal + currentValue.population;
}, 0);
